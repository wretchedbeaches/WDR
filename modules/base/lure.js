    ...
    message.channel.send(instruction).catch(console.error).then( msg => {
      ...
      collector.on('collect', message => {
        switch(true){
	      ...
	      case 'rainy': collector.stop('Rainy'); break;
              default: message.reply('`'+message.content+'` doesn\'t appear to be a valid Lure Type. Please check the spelling and try again.').then(m => m.delete({ timeout: 5000, reason: 'It had to be done.' })).catch(console.error);
            } break;
